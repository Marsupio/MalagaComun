...
echo '<h2>Listado completo de TODOS los usuarios.</h2>';
echo '<p align="center">Actualmente hay registrados <b>'.$cantidad.'</b> usuarios.</p>';
...
/*********************************/	  
	...
	if ($comunes<0)
	{
	  echo '<td style=" font-weight:bold; color:#a00;">' . $row['COMUNES'] . '</td>'; 
	}
	elseif ($comunes>0)
	{
	  echo '<td style="font-weight:bold; color:#080">' . $row['COMUNES'] . '</td>'; 	
	}
	else
	{
	  echo '<td style="font-weight:bold; color:#000">' . $row['COMUNES'] . '</td>'; 			
	}
/************************************/	  
	   
  	  echo "<td> <a href='mostrar_usuario.php?email=$email'><button>Ver</button></a></td>";     
...
echo "<br><p align='center'>Total de usuarios: " .'<b>'.  $cantidad .'</b>'. " personas.</p>";
echo '<br><p align="center"><a href="usuarios.php"><button>Pulse aqu&iacute; para volver</button></a></p>';
