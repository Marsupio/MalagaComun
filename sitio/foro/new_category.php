...
<div class="box">
	...
	<div class="box_left">
        ...
        <br /><br />
        <p id="texto_blanco">Nueva Categoría</p>
    </div>
...
if(isset($_POST['name'], $_POST['description']) and $_POST['name']!='')
{
	...
	{
	?>
	<div class="message">Se ha creado esa categoría correctamente.
    <br /><br />
	<a class="button" href="<?php echo $url_home; ?>">Ir al Indice</a>
    </div>
	<?php
	}
	else
	{
		echo 'Ocurrió un error mientras se creaba esa categoría.';
	}
}
else
{
...
<form action="new_category.php" method="post">
	<label for="name"><span id="texto_blanco">Nombre de la Categoría<span>
    </label><input type="text" name="name" id="name" />
    <br />
    <br />
	<label for="description"><p id="texto_blanco">Descripción</p></label>
    <br />
    <br />
    <textarea name="description" id="description" cols="70" rows="6"></textarea>
    <br />
    <br />
    <p align="center"><input id="boton" type="submit" value="Create" /></p>
</form>
<?php
}
?>
