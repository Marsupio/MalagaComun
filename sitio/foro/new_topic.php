...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Nuevo Tema - <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?> - Forum</title>
...
if(isset($_POST['message'], $_POST['title']) and $_POST['message']!='' and $_POST['title']!='')
{
	...
	{
	?>
	<div class="message">El tema ha sido creado correctamente.
    <br />
    <br />
	<a class="button" href="list_topics.php?parent=<?php echo $id; ?>">Ir al Foro</a></div>
	<?php
	}
	else
	{
		echo 'Ocurrió un error mientras se creaba ese tema.';
	}
}
else
{
...
<form action="new_topic.php?parent=<?php echo $id; ?>" method="post">
	<label for="title"><p id="texto_blanco">Título del Nuevo Tema:</p>
    </label><input type="text" name="title" id="title"  />
    <br />
    <br />
    <label for="message"><p id="texto_blanco">Descripción:</p></label>
    <br />
    <br />
    <!--
    ...
    <br />
    <br />
    <input id="boton" type="submit" value="Publicar" />
</form>
<?php
}
?>
