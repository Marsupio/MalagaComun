	...
	var prologue_settings = {
		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				useOrientation: true,
				breakpoints: {
					'widest':	{ range: '1980-', hasStyleSheet: false, containers: 1400, grid: { gutters: 40 } },
					'wide':	{ range: '961-1980', containers: 1200, grid: { gutters: 40 } },
