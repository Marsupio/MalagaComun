...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			'Julio', 'Agosto', 'Septiembre', 'Octybre', 'Noviembre', 'Diciembre'],
			...
			prevText: '&lt;Previo', // Text for the previous month command
			prevStatus: 'Muestra el mes anterior', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Muestra el año anterior', // Status text for the previous year command
			nextText: 'Siguiente&gt;', // Text for the next month command
			nextStatus: 'Muestra el próximo mes', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'Muestra el siguiente año', // Status text for the next year command
			currentText: 'Actual', // Text for the current month command
			currentStatus: 'Muestra el mes actual', // Status text for the current month command
			todayText: 'Hoy', // Text for the today's month command
			todayStatus: 'Muestra el dia del mes actual', // Status text for the today's month command
			clearText: 'Borrar', // Text for the clear command
			clearStatus: 'Borra todas las fechas', // Status text for the clear command
			closeText: 'Cerrar', // Text for the close command
			closeStatus: 'Cierra el calendario', // Status text for the close command
			yearStatus: 'Cambia el año', // Status text for year selection
			monthStatus: 'Cambia el mes', // Status text for month selection
